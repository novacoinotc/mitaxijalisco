...
function GdlMap({ progress = 0, showRoute = true, showSosRing = false, deviation = false }: { progress?: number; showRoute?: boolean; showSosRing?: boolean; deviation?: boolean }) {
  ...
  return (
    <div className="rounded-2xl overflow-hidden border border-white/10 h-[260px] relative bg-gradient-to-br from-[#0a1420] to-[#081020]">
      {/* Water / parks */}
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 360 260" preserveAspectRatio="none">
        ...
        <text x="280" y="58" textAnchor="middle" fontSize="7" fill="rgba(182,255,60,0.7)">Los Colomos</text>
        ...
        {showRoute && (
          <path
            ...
            stroke={deviation ? "#ff2bd6" : "url(#rt)"}
            strokeWidth="3.5"
            fill="none"
        ...
        <text x="108" y="225" fontSize="8" fill="#ff2bd6" fontWeight="bold">Av. Chapultepec 123</text>

        {/* Destination marker */}
        <circle cx="320" cy="60" r="5" fill="#b6ff3c" />
        <circle cx="320" cy="60" r="10" fill="none" stroke="#b6ff3c" strokeOpacity="0.4" strokeWidth="2" />
        <text x="270" y="48" fontSize="8" fill="#b6ff3c" fontWeight="bold">Plaza del Sol</text>
      </svg>
